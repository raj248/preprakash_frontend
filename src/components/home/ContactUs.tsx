      ...
      <section className="contact__section section--padding">
        <div className="container">
          ...
          <div className="contact__section--heading text-center mb-40">
            <h2 className="contact__section--heading__maintitle">
              Get In Touch
            </h2>
...
const ContactInfoBlock = ({ title, icon, children }: any) => (
  <div className="contact__info--items">
...
// --- SVG Icons (Keep your path data here) ---
const PhoneIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="31.568"
...
// ... (Add EmailIcon and LocationIcon following the same pattern)
